# SetupAPI Code from https://github.com/jborean93/packer-windoze/blob/master/roles/personalise/files/remove_device.ps1
# Credit to jborean93
...
function Find-SafelyRemoveHardwareDevices () {
    $devicesWithSafeRemovalRequired = [SetupAPI.Device]::EnumerateDevices() | Where-Object {
        $_.GetProperty("DEVPKEY_Device_SafeRemovalRequired", $false) -eq $true
    }
    return $devicesWithSafeRemovalRequired
}

Write-Host "SetupAPITools Loaded. [v0.1]"